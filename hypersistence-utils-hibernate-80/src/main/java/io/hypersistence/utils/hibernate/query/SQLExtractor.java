...
public class SQLExtractor {
    ...
    private static String extractSelectSql(AbstractSqmQuery<?> querySqm, SqmSelectStatement<?> sqmSelect) {
        ...
        SqlAstTranslator<JdbcSelect> translator = factory.getJdbcServices()
            .getJdbcEnvironment()
            .getSqlAstTranslatorFactory()
            .buildTranslator(new SqlAstTranslationRequest.Select(factory, sqmInterpretation.getSqlAst()));

        JdbcSelect jdbcSelect = translator.translate(jdbcParameterBindings, queryOptions);
    ...
    private static String extractMutationSql(AbstractSqmQuery<?> querySqm, SqmDmlStatement<?> sqmDml) {
        ...
        // Step 3: Translate SQL AST to JDBC operation (produces the SQL string)
        SqlAstTranslator<JdbcOperationQueryMutation> translator = factory.getJdbcServices()
            .getJdbcEnvironment()
            .getSqlAstTranslatorFactory()
            .buildTranslator(new SqlAstTranslationRequest.QueryMutation(factory, sqmInterpretation.getSqlAst()));
