...
public class PostgreSQLYearMonthEpochTest extends AbstractPostgreSQLIntegrationTest {
    ...
    public void testIndexing() {
        ...
        List<String> executionPlanLines = doInJPA((EntityManagerTransactionFunction<List<String>>) entityManager -> {
            ...
            .setParameter("startYearMonth", new TypedParameterValue<>(YearMonthEpochType.INSTANCE,  YearMonth.of(2010, 12)))
            .setParameter("endYearMonth", new TypedParameterValue<>(YearMonthEpochType.INSTANCE,  YearMonth.of(2018, 1)))
            .getResultList();
        });
