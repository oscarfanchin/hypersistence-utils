...
public class PostgreSQLYearMonthIntegerTest extends AbstractPostgreSQLIntegrationTest {
    ...
    public void testIndexing() {
        ...
        List<String> executionPlanLines = doInJPA((EntityManagerTransactionFunction<List<String>>) entityManager -> {
            return entityManager.createNativeQuery(
                "EXPLAIN ANALYZE " +
                    ...
                    .setParameter("startYearMonth", new TypedParameterValue<>(YearMonthIntegerType.INSTANCE,  YearMonth.of(2010, 12)))
                    .setParameter("endYearMonth", new TypedParameterValue<>(YearMonthIntegerType.INSTANCE,  YearMonth.of(2018, 1)))
                .getResultList();
        });
